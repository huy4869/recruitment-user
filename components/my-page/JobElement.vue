...
export default {
  ...
  computed: {
    ...
    showAddress() {
      ...
      return (this.job.postal_code ? ('〒' + this.zipCodeFormat(this.job.postal_code)) : '') + ' ' + this.job.address.province + this.job.address.district + this.job.address.address + (this.job.address.building ?? '')
    },
    showStation() {
